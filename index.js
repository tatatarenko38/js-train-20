...
Car.prototype.brake = function (decrement) {
  ...
  console.log(
    `Автомобіль з ${this.brand} ${this.model} зменьшив швидкість до ${this.speed} км/год`
  );
};
...
//const boundFunction = fullName.bind(person, 'New York', 'USA');
const driveCar = Car.prototype.drive.bind(car);
